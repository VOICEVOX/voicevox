...
describe("store/vuex.js test", () => {
  it("create store", () => {
    ...
    assert.isObject(store.state.undoCommands);
    assert.isArray(store.state.undoCommands.talk);
    assert.isEmpty(store.state.undoCommands.talk);
    assert.isArray(store.state.undoCommands.song);
    assert.isEmpty(store.state.undoCommands.song);
    assert.isObject(store.state.redoCommands);
    assert.isArray(store.state.redoCommands.talk);
    assert.isEmpty(store.state.redoCommands.talk);
    assert.isArray(store.state.redoCommands.song);
    assert.isEmpty(store.state.redoCommands.song);
