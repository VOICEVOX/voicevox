...
flowchart TD
  ...
  846215{" "} -->|"refresh"| 186768["REFRESH_APP"]
  node_1 -->|"×ボタン"| 295190(["close"])
  node_1 -->|"アプリを再読み込み"| 929152(["refresh"])
  ...
  subgraph 186768["REFRESH_APP"]
    705785[["terminateEngines"]] --> 700765{{"alreadyCompleted?"}}
    700765 -->|"false"| 462289["await"]
    700765 -->|"true"| 464405[["launchEngines"]]
    462289 --> 464405
    464405 --> 198115>"win.reload"]
  end
  ...
  subgraph 793927["terminateEngines"]
  ...
  subgraph subgraph_2["app.before_quit"]
    ...
    c -->|"true"| 454139[["terminateEngines"]]
    454139 --> 177756
