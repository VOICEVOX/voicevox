...
import lineStripVertexShaderSource from "@/song/graphics/shaders/lineStripVertexShader.glsl?raw";
import fragmentShaderSource from "@/song/graphics/shaders/fragmentShader.glsl?raw";
