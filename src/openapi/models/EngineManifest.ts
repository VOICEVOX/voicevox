...
export function EngineManifestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    dependencyLicenses: (json["dependency_licenses"] as Array<any>).map(
      LicenseInfoFromJSON
    ),
    supportedVvlibManifestVersion: !exists(
      json,
      "supported_vvlib_manifest_version"
    )
      ? undefined
      : json["supported_vvlib_manifest_version"],
...
export function EngineManifestToJSON(value?: EngineManifest | null): any {
  ...
  return {
    ...
    dependency_licenses: (value.dependencyLicenses as Array<any>).map(
      LicenseInfoToJSON
    ),
