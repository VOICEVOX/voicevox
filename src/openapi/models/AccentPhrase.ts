...
import { MoraFromJSON, MoraFromJSONTyped, MoraToJSON } from "./Mora";
...
export function AccentPhraseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    accent: json["accent"],
    pauseMora: !exists(json, "pause_mora")
      ? undefined
      : MoraFromJSON(json["pause_mora"]),
    isInterrogative: !exists(json, "is_interrogative")
      ? undefined
      : json["is_interrogative"],
  };
}
