...
export function SpeakerSupportedFeaturesFromJSON(
  json: any
): SpeakerSupportedFeatures {
  return SpeakerSupportedFeaturesFromJSONTyped(json, false);
}

export function SpeakerSupportedFeaturesFromJSONTyped(
  json: any,
  ...
  return {
    permittedSynthesisMorphing: !exists(json, "permitted_synthesis_morphing")
      ? undefined
      : SpeakerSupportPermittedSynthesisMorphingFromJSON(
          json["permitted_synthesis_morphing"]
        ),
  };
}

export function SpeakerSupportedFeaturesToJSON(
  value?: SpeakerSupportedFeatures | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    permitted_synthesis_morphing:
      SpeakerSupportPermittedSynthesisMorphingToJSON(
        value.permittedSynthesisMorphing
      ),
  };
}
