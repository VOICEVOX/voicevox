...
export interface IsMorphableIsMorphableGetRequest {
    baseSpeaker: number;
...
export interface DefaultApiInterface {
    ...
    /**
     * 指定された2人の話者でモーフィング機能を利用可能か返します。 モーフィングの許可/禁止は`/speakers`の`speaker.supported_features.synthesisMorphing`に記載されています。 プロパティが存在しない場合は、モーフィングが許可されているとみなします。
     ...
     * @memberof DefaultApiInterface
     */
    isMorphableIsMorphableGetRaw(requestParameters: IsMorphableIsMorphableGetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<boolean>>;

    /**
     * 指定された2人の話者でモーフィング機能を利用可能か返します。 モーフィングの許可/禁止は`/speakers`の`speaker.supported_features.synthesisMorphing`に記載されています。 プロパティが存在しない場合は、モーフィングが許可されているとみなします。
     * 2人の話者でモーフィングが可能かどうか返す
     */
    isMorphableIsMorphableGet(requestParameters: IsMorphableIsMorphableGetRequest, initOverrides?: RequestInit): Promise<boolean>;
...
export class DefaultApi extends runtime.BaseAPI implements DefaultApiInterface {
     ...
     * 2人の話者でモーフィングが可能かどうか返す
     */
    async isMorphableIsMorphableGetRaw(requestParameters: IsMorphableIsMorphableGetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<boolean>> {
        if (requestParameters.baseSpeaker === null || requestParameters.baseSpeaker === undefined) {
            throw new runtime.RequiredError('baseSpeaker','Required parameter requestParameters.baseSpeaker was null or undefined when calling isMorphableIsMorphableGet.');
        }

        if (requestParameters.targetSpeaker === null || requestParameters.targetSpeaker === undefined) {
            throw new runtime.RequiredError('targetSpeaker','Required parameter requestParameters.targetSpeaker was null or undefined when calling isMorphableIsMorphableGet.');
        }
     ...
     * 2人の話者でモーフィングが可能かどうか返す
     */
    async isMorphableIsMorphableGet(requestParameters: IsMorphableIsMorphableGetRequest, initOverrides?: RequestInit): Promise<boolean> {
        const response = await this.isMorphableIsMorphableGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
