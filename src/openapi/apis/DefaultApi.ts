...
export interface PeriodicPitchPeriodicPitchPostRequest {
    speaker: number;
    audioQuery: AudioQuery;
    coreVersion?: string;
}
...
export interface DefaultApiInterface {
     ...
     * @memberof DefaultApiInterface
     */
    periodicPitchPeriodicPitchPostRaw(requestParameters: PeriodicPitchPeriodicPitchPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AudioQuery>>;

    /**
     * 音声合成用のクエリから音高の時系列を得る
     */
    periodicPitchPeriodicPitchPost(requestParameters: PeriodicPitchPeriodicPitchPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AudioQuery>;
...
export class DefaultApi extends runtime.BaseAPI implements DefaultApiInterface {
     ...
     * 音声合成用のクエリから音高の時系列を得る
     */
    async periodicPitchPeriodicPitchPostRaw(requestParameters: PeriodicPitchPeriodicPitchPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AudioQuery>> {
        if (requestParameters.speaker === null || requestParameters.speaker === undefined) {
            throw new runtime.RequiredError('speaker','Required parameter requestParameters.speaker was null or undefined when calling periodicPitchPeriodicPitchPost.');
        }

        if (requestParameters.audioQuery === null || requestParameters.audioQuery === undefined) {
            throw new runtime.RequiredError('audioQuery','Required parameter requestParameters.audioQuery was null or undefined when calling periodicPitchPeriodicPitchPost.');
        }
     ...
     * 音声合成用のクエリから音高の時系列を得る
     */
    async periodicPitchPeriodicPitchPost(requestParameters: PeriodicPitchPeriodicPitchPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AudioQuery> {
        const response = await this.periodicPitchPeriodicPitchPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
