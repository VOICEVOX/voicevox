...
export interface DefaultApiInterface {
    ...
    /**
     * ダウンロード可能なライブラリの情報を返します。  Returns ------- ret_data: List[DownloadableLibrary]
    ...
    /**
     * ライブラリをインストールします。 ライブラリのZIPファイルをリクエストボディとして送信してください。  Parameters ---------- library_uuid: str     ライブラリのID
    ...
    /**
     * インストールしたライブラリの情報を返します。  Returns ------- ret_data: List[DownloadableLibrary]
     * @summary Installed Libraries
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof DefaultApiInterface
     */
    installedLibrariesInstalledLibrariesGetRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<DownloadableLibrary>>>;

    /**
     * インストールしたライブラリの情報を返します。  Returns ------- ret_data: List[DownloadableLibrary]
     * Installed Libraries
     */
    installedLibrariesInstalledLibrariesGet(initOverrides?: RequestInit): Promise<Array<DownloadableLibrary>>;
...
export class DefaultApi extends runtime.BaseAPI implements DefaultApiInterface {
     ...
     * Installed Libraries
     */
    async installedLibrariesInstalledLibrariesGetRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<DownloadableLibrary>>> {
        const queryParameters: any = {};
     ...
     * Installed Libraries
     */
    async installedLibrariesInstalledLibrariesGet(initOverrides?: RequestInit): Promise<Array<DownloadableLibrary>> {
