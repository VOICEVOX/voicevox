...
export const oldDictionaryManageDialogContextKey: InjectionKey<{
  ...
  toInitialState: () => void;
  cancel: () => void;
}> = Symbol("oldDictionaryManageDialogContextKey");
</script>
...
import OldDictionaryEditWordDialog from "./OldDictionaryEditWordDialog.vue";
...
provide(oldDictionaryManageDialogContextKey, {
  wordEditing,
  surfaceInput,
  editTarget,
  isEditingNewWord,
