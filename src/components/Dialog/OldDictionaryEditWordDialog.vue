...
import { oldDictionaryManageDialogContextKey } from "./OldDictionaryManageDialog.vue";
...
const context = inject(oldDictionaryManageDialogContextKey);
if (context == undefined)
  throw new Error(`oldDictionaryManageDialogContext == undefined`);
const {
  wordEditing,
  surfaceInput,
  editTarget,
