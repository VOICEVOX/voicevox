...
import { frequencyToNoteNumber, secondToTick } from "@/song/music";
import {
  UNVOICED_PHONEMES,
  VALUE_INDICATING_NO_DATA,
  convertToFramePhonemes,
} from "@/song/domain";
import { noteNumberToBaseY, tickToBaseX } from "@/song/viewHelper";
...
.canvas-container {
  overflow: hidden;
  z-index: vars.$z-index-song-pitch;
  pointer-events: none;
  position: relative;
