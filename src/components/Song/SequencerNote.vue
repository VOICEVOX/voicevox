...
.note {
  ...
  .note-bar {
    ...
    width: calc(100% + 1px);
    height: 100%;
    background-color: var(--scheme-color-song-note-bar-container);
    border: 1px solid var(--scheme-color-song-note-bar-border);
    border-radius: 5px;
  }
  ...
  .note-edge {
    ...
    &:hover {
      background-color: var(--scheme-color-song-note-bar-border);
    }
  }
}
...
.note.edit-note {
  ...
  &.selected {
    .note-bar {
      background-color: var(--scheme-color-song-note-bar-selected-container);
      border-color: var(--scheme-color-song-note-bar-selected-border);
      outline: 1px solid var(--scheme-color-song-note-bar-selected-outline);
      outline-offset: 1px;
    }

    .note-edge:hover {
      background-color: var(--scheme-color-song-note-bar-selected-border);
    }
  }
  ...
  &.preview-lyric {
    .note-bar {
      background-color: var(--scheme-color-song-note-bar-preview-container);
      border-color: var(--scheme-color-song-note-bar-preview-border);
      outline-color: var(--scheme-color-song-note-bar-preview-outline);
    }
  }
...
.note.edit-pitch {
  // ノートバー
  .note-bar {
    background-color: var(--scheme-color-song-note-bar-below-pitch-container);
    border-color: var(--scheme-color-song-grid-cell-white);
    outline: 0;
  }
...
.note-lyric {
  ...
  color: var(--scheme-color-song-on-note-bar-container);
  @include text-outline(var(--scheme-color-song-note-bar-container));
  -webkit-font-smoothing: antialiased;
  z-index: vars.$z-index-song-note;
}
...
.note-lyric.edit-note {
  ...
  // 追加中
  &.adding {
    color: var(--scheme-color-song-on-note-bar-selected-container);
    @include text-outline(var(--scheme-color-song-note-bar-selected-container));
  }

  // 歌詞プレビュー中
  &.preview-lyric {
    color: oklch(
      from var(--scheme-color-song-on-note-bar-container) l c h / 0.38
    );
    @include text-outline(var(--scheme-color-song-note-bar-preview-container));
  }
...
.note-lyric.edit-pitch {
  ...
  z-index: vars.$z-index-song-note-lyric;
