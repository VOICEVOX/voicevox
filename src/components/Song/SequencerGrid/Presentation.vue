...
import { getNoteDuration, measureNumberToTick } from "@/song/music";
...
.sequencer-grid-cell-white {
  fill: var(--scheme-color-song-grid-cell-white);
}

.sequencer-grid-cell-black {
  fill: var(--scheme-color-song-grid-cell-black);
}

.sequencer-grid-vertical-line {
  stroke: var(--scheme-color-song-grid-vertical-line);
  stroke-width: 1px;
}

.sequencer-grid-horizontal-line {
  backface-visibility: hidden;
  stroke: var(--scheme-color-song-grid-horizontal-line);
  stroke-width: 1px;
}

.sequencer-grid-octave-line {
  backface-visibility: hidden;
  stroke: var(--scheme-color-song-grid-octave-line);
  stroke-width: 1px;
}

.sequencer-grid-measure-line {
  backface-visibility: hidden;
  stroke: var(--scheme-color-song-grid-measure-line);
  stroke-width: 1px;
}

.sequencer-grid-beat-line {
  backface-visibility: hidden;
  stroke: var(--scheme-color-song-grid-beat-line);
  stroke-width: 1px;
}
