...
import { keyInfos, getKeyBaseHeight } from "@/song/viewHelper";
...
.white-key-background {
  fill: var(--scheme-color-song-piano-key-white);
}
...
.black-key {
  fill: var(--scheme-color-song-piano-key-black);
}
...
.keys-right-border {
  stroke: var(--scheme-color-song-piano-keys-right-border);
  stroke-width: 1px;
}
