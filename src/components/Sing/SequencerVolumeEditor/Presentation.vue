<template>
  ...
  >
    ...
    />
    <canvas ref="canvas" class="volume-editor-canvas" @wheel="handleWheel" />
    <Tooltip
      :state="tooltipState"
      :tooltipStyle
...
const props = defineProps<{
  ...
  effectiveFramewise: readonly number[];
...
const volumeSegments = computed(() =>
  buildVolumeSegments(props.effectiveFramewise, {
    ...
    valueToNormalizedY: (value) =>
      volumeValueScale.dbToNormalizedY(volumeValueScale.valueToDb(value)),
  }),
);
